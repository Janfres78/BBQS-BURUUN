...
<head>
	...
	<title>Barangay Purok - BBQS BURU-UN</title>
</head>
<body>
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Purok President</th>
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a type="button" href="#edit" data-toggle="modal" class="btn btn-link btn-primary" title="Edit Purok" onclick="editPurok(this)" 
                                                                    data-name="<?= $row['name'] ?>" data-details="<?= $row['details'] ?>" data-cellphone_number="<?= $row['cellphone_number'] ?>" data-id="<?= $row['id'] ?>">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_purok.php" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Purok President" name="details">
                                </div>
                                <div class="form-group">
                                    <label>Cell Phone No.</label>
                                    <input type="text" class="form-control" placeholder="Enter CellPhone No." name="cellphone_number">
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/edit_purok.php" >
                                ...
                                <div class="form-group">
                                    <label>Purok President</label>
                                    <input type="text" class="form-control" id="details" placeholder="Enter Purok President" name="details">
                                </div>
                                <div class="form-group">
                                    <label>Cell Phone No.</label>
                                    <input type="text" class="form-control" id="cellphone_number" placeholder="Enter CellPhone No." name="cellphone_number">
                                </div>
