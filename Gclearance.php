...
<head>
	...
	<title>Certificate of Residency - BBQS BURU-UN</title>
    <style>
        @page  
        { 
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            ...
                                            <h2 class="mt-3" style="text-indent: 40px;">THIS IS TO CERTIFY that <span class="fw-bold" style="font-size:22px"><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></span>, 
                                            ...
                                            <h2 class="mt-3" style="text-indent: 40px;">Further this certifies that she is a resident of this barangay since </span> <span contenteditable="true" class="editable"></span>up to present.</h2>
