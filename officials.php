...
<head>
	...
	<title>Brg Officials and Staff - BBQS BURU-UN</title>
</head>
<body>
															...
															<?php if(isset($_SESSION['username'])):?>
																...
																<td>
																	<a type="button" href="#edit" data-toggle="modal" class="btn btn-link btn-primary" 
																		...
																		data-end="<?= $row['termend'] ?>" data-status="<?= $row['status'] ?>" data-contact_number="<?= $row['contact_number'] ?>">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_official.php" >
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Contact No." name="contact_number" required>
                                </div>
								<div class="form-group">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/edit_official.php" >
								...
								<div class="form-group">
                                    <label>Contact No.</label>
                                    <input type="text" class="form-control" id="contact_number" placeholder="Enter Contact No." name="contact_number" required>
                                </div>
								<div class="form-group">
                                    <label>Chairmanship</label>
