...
<head>
	...
	<title>Barangay Clearance - BBQS BURU-UN</title>
    <style>
        @page  
        { 
					...
					<div class="row mt--2">
						<div class="col-md-12">
                            ...
                            <div class="card">
								...
								<div class="card-body" id="printThis" style="margin: 10px;">
                                <div class="d-flex flex-wrap justify-content-around" style="margin-bottom: 10px;">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        ...
                                        <h2 class="mt-3" style="text-indent: 40px;">
                                            THIS IS TO CERTIFY that <span style="font-size:22px"><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></span>, 
                                            of legal age, and resident of <span style="font-size:22px"><?= ucwords($resident['purok']) ?></span>,
                                            <span style="font-size:22px"><?= ucwords($brgy) ?></span>.
                                        </h2>
                                        <h2 class="mt-3" style="text-indent: 40px;">
                                            Is known to me personally to be of good moral character and a law-abiding citizen in the community.
                                        </h2>
                                        <h2 class="mt-3" style="text-indent: 40px;">
                                            Issued this <span class="fw-bold" style="font-size:25px">BARANGAY CLEARANCE</span> 
                                            <span class="static-text">upon the request of</span> <span contenteditable="true" class="editable"></span> 
                                            <span class="static-text">to support for his/her application for</span> <span contenteditable="true" class="editable"></span>.
                                        </h2>
                                            ...
                                            document.querySelectorAll('.editable').forEach(function(span) {
                                                ...
                                                <div class="col-md-12">
                                                <h2 style="text-align: left; margin-top: 50px;">Given this 
                                                <span class="fw-bold" style="font-size:25px"><?= date('m/d/Y') ?></span></h2>
