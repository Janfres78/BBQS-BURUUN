...
<head>
	...
	<title>Business Permit - BBQS BURU-UN</title>
    <style>
        @page  
        { 
					...
					<div class="row mt--2">
						<div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex flex-wrap justify-content-around" style="border-bottom:1px solid red; margin-bottom: 10px;">
                                    <div class="text-center">
                                        <img src="assets/img/bb123456.png" height="120" width="1070" style="max-width: 100%; height: auto;">
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        ...
                                        <div class="text-center">
                                            <h1 class="mt-4 fw-bold mb-5" style="font-size:38px; color:darkblue;">BARANGAY CLEARANCE</h1>
                                        </div>
                                        <h2 class="mt-5 fw-bold">TO WHOM IT MAY CONCERN:</h2>
                                        <h2 class="mt-3" style="text-indent: 40px;">
                                            THIS IS TO CERTIFY that <span class="fw-bold" style="font-size:25px"><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></span>, 
                                            of legal age, and resident of <span class="static-text" style="font-size:25px"><?= ucwords($resident['purok']) ?></span>,
                                            <span class="static-text" style="text-indent:25px"><?= ucwords($brgy) ?></span>, 
                                            <span class="static-text" style="text-indent:25px"><?= ucwords($town) ?></span>, 
                                            <span class="static-text" style="text-indent:25pxs"><?= ucwords($resident['gender']) ?></span>, 
                                            is the owner and operator of <span contenteditable="true" class="editable"></span>.
                                        </h2>
                                        <h2 class="mt-3" style="text-indent: 40px;">
                                            Issued this <span class="fw-bold" style="font-size:25px"><?=('CERTIFICATION') ?></span>
                                            upon the request of <span contenteditable="true" class="editable"></span> 
                                            to support for his/her application for <span contenteditable="true" class="editable"></span>.
                                        </h2>
                                            <style>
                                    ...
                                    <h2 class="mt-5">
                                                    Given this <span class="fw-bold" style="font-size:25px"><?= date('m/d/Y') ?></span>.
                                                </h2>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="p-3 text-right mr-5" style="margin-top: 200px;">
                                                    ...
                                                    <h2 style="text-align: left; margin-top: 50px;">“Not valid if without official seal”</h2>
                                                </div>
                                                <div class="text-center mt-5">
                                                    <img src="assets/img/bb7878.png" height="120" width="1070" style="max-width: 100%; margin-top: 200px;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
