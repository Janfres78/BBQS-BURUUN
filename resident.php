...
<?php 
    // Fetch all active residents (where is_deleted = 0)
    $query = "SELECT * FROM tblresident WHERE is_deleted = 0";
...
<head>
	...
	<title>Resident Information - BBQS BURU-UN</title>
</head>
<body>
														...
														<td>
															<div class="form-button-action">
                                                                <a type="button" href="#edit" data-toggle="modal" class="btn btn-link btn-primary" title="View Resident" onclick="editResident(this)" 
                                                                    data-id="<?= $row['id'] ?>" data-national="<?= $row['national_id'] ?>" data-precinct_number="<?= $row['precinct_number'] ?>" data-fname="<?= $row['firstname'] ?>" data-mname="<?= $row['middlename'] ?>" data-lname="<?= $row['lastname'] ?>"
                                                                    data-skills="<?= $row['skills'] ?>" data-bplace="<?= $row['birthplace'] ?>" data-bdate="<?= $row['birthdate'] ?>" data-age="<?= $row['age'] ?>"
                                                                    data-category="<?= $row['demographic_group'] ?>" data-cstatus="<?= $row['civilstatus'] ?>" data-gender="<?= $row['gender'] ?>"data-purok="<?= $row['purok'] ?>" data-vstatus="<?= $row['voterstatus'] ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Precinct #" name="precinct_number" required>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Category Group</label>
                                           <select class="form-control" name="category">
                                              ...
                                              <option value="ERPAT(BELA)">ERPAT(BELA)</option>
                                              <option value="WOMENS FEDERATION">WOMENS FEDERATION</option>
                                            </select>
                                            </div>
                                        </div>
                                            <div class="col">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label>Skills</label>
                                                <input type="text" class="form-control" placeholder="Enter skills" id="skills" name="skills"
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label>Precinct Number</label>
                                                <input type="text" class="form-control" placeholder="Enter Precinct #" id="precinct_number" name="precinct_number" value="<?php echo isset($row['precinct_number']) ? $row['precinct_number'] : ''; ?>">      
                                            </div>                                    
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Category Group</label>
                                           <select class="form-control" required name="category" id="category">
                                              ...
                                              <option value="None" <?php echo (isset($row['category']) && $row['category'] == 'None') ? 'selected' : ''; ?>>None</option>
                                              <option value="Senior Citizen" <?php echo (isset($row['category']) && $row['category'] == 'Senior Citizen') ? 'selected' : ''; ?>>Senior Citizen</option>
                                              <option value="PWDs" <?php echo (isset($row['category']) && $row['category'] == 'PWDs') ? 'selected' : ''; ?>>PWDs</option>
                                              <option value="ERPAT(BELA)" <?php echo (isset($row['category']) && $row['category'] == 'ERPAT(BELA)') ? 'selected' : ''; ?>>ERPAT(BELA)</option>
                                              <option value="WOMENS FEDERATION" <?php echo (isset($row['category']) && $row['category'] == 'WOMENS FEDERATION') ? 'selected' : ''; ?>>WOMENS FEDERATION</option>
                                            </select>
                                            </div>
                                        </div>
                                            <div class="col">
