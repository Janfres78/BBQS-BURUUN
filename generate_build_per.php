...
<head>
	...
	<title>Building Permit - BBQS BURU-UN</title>
    <style>
        @page  
        { 
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Building Permit</div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        ...
                                        <div class="text-center">
                                            <h1 class="mt-4 fw-bold mb-5" style="font-size:38px; color:darkblue;">C E R T I F I C A T I O N</h1>
                                        </div>
                                        ...
                                        <h2 class="mt-3" style="text-indent: 40px;">
                                            ...
                                            <span class="static-text" style="font-size:25px"><?= ucwords($resident['gender']) ?></span>,
                                            has been given clearance from this barangay to apply for Building Permit/Occupancy Permit for 
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_pment.php" >
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="Enter Payment Details" name="details">Building Permit Payment</textarea>
                                </div>
                        </div>
