...
<head>
	...
	<title>Generate Resident Profile - BBQS BURU-UN</title>
</head>
<body>
                            ...
                            <div class="card">
								...
								<div class="card-body m-5" id="printThis">
                                    <div class="d-flex flex-wrap justify-content-center" style="border-bottom:1px solid red">
                                        ...
                                        <img src="assets/img/bb123456.png" height="150" width="1070" >										</div>
									</div>
                                    <div class="row mt-2">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <div class="form-group row">
                                                        <h3 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Precinct No.</h3>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                        <input type="text" class="form-control fw-bold" style="font-size:20px" value="<?= $resident['precinct_number'] ?>">
                                                    </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="form-group row">
                                                        <h3 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Skills:</h3>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                        <input type="text" class="form-control fw-bold" style="font-size:20px" value="<?= $resident['skills'] ?>">
                                                    </div>
                                                    <div class="form-group row">
                                                        <h3 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Org Group:</h3>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                    <input type="text" class="form-control fw-bold" style="font-size:20px" value="<?= htmlspecialchars($resident['demographic_group']); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
